...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Engenharia de Software/Projetos/COVID/CoView/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n      <button ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    <ion-title>\n      CoView\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  \n    <video webkit-playsinline playsinline autoplay loop muted id="backgroundvideo">\n        <source src="./assets/imgs/bus.mp4" type=\'video/mp4; codecs="h.264"\'>\n        <source src="./assets/imgs/bus.webm" type="video/webm">\n      </video> \n  \n  <ion-slides autoplay="4000" pager loop>\n    <ion-slide>\n        <h4>Before</h4>\n        <p>Before Covid in places</p>\n    </ion-slide>\n    <ion-slide>\n        <h4>After</h4>\n        <p>AfterCovid in places</p>\n    </ion-slide>\n    <ion-slide>\n        <h4>Side by Side</h4>\n        <p>Before and after analysis</p>\n    </ion-slide>\n</ion-slides>\n</ion-content>\n'/*ion-inline-end:"/Engenharia de Software/Projetos/COVID/CoView/src/pages/home/home.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/Engenharia de Software/Projetos/COVID/CoView/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Engenharia de Software/Projetos/COVID/CoView/src/pages/list/list.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Engenharia de Software/Projetos/COVID/CoView/src/app/app.html"*/'<ion-split-pane>\n\n  <!--  our side menu  -->\n  <ion-menu [content]="content" type="overlay">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Menu</ion-title>\n      </ion-toolbar>\n    </ion-header>\n  \n    <ion-content>\n      <ion-list>\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n          {{p.title}}\n        </button>\n      </ion-list>\n    </ion-content>\n  \n  </ion-menu>\n\n  <!-- the main content -->\n  <ion-nav [root]="rootPage" main #content swipeBackEnabled="false"></ion-nav>\n\n</ion-split-pane>\n'/*ion-inline-end:"/Engenharia de Software/Projetos/COVID/CoView/src/app/app.html"*/
        }),
...
var MapPage = /** @class */ (function () {
    ...
    MapPage.prototype.SideMap = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_leaflet__["tileLayer"]('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    ...
    MapPage.prototype.addPoint = function () {
        for (var _i = 0, _a = this.points; _i < _a.length; _i++) {
            var property = _a[_i];
            __WEBPACK_IMPORTED_MODULE_2_leaflet__["marker"]([property.lat, property.long]).addTo(this.map)
                .bindPopup(property.point + '<img src="' + property.img + '"/> ' + '<br>' + ("" + "this.openModal(pointanalysis)"));
        }
    };
    MapPage.prototype.openModal = function (pointanalysis) {
        var mymodal = this.modal.create('PointanalysisPage', { COD: pointanalysis.COD });
        mymodal.present();
    };
    MapPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-map',template:/*ion-inline-start:"/Engenharia de Software/Projetos/COVID/CoView/src/pages/map/map.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Map</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <div id="map" style="width:100%; height:100%;"></div>\n</ion-content>\n'/*ion-inline-end:"/Engenharia de Software/Projetos/COVID/CoView/src/pages/map/map.html"*/,
        }),
