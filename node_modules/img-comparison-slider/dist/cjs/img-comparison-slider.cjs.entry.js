...
const __chunk_1 = require('./chunk-0f4ecaf9.js');
...
class ImgComparisonSlider {
    ...
    render() {
        return __chunk_1.h("div", null, __chunk_1.h("div", { ref: el => this.before = el }, __chunk_1.h("slot", { name: "before" })), __chunk_1.h("div", { class: "after", ref: el => this.after = el }, __chunk_1.h("div", { class: "hint" }), __chunk_1.h("div", { class: "after-overlay" }, __chunk_1.h("div", { ref: el => this.afterImageContainer = el }, __chunk_1.h("slot", { name: "after" })))));
    }
